...
export const getMovieRecommendations = async (title, director, genre) => {
    const prompt = `Suggest 3 movies similar to "${title}" by  ${director} in the ${genre} genre  by. Return in JSON format with title and author.`;
